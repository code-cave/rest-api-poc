...
public class PutProductServiceV1 {
    ...
    private Product updateMongo(RequestVO requestVO) {
        // Attempt to update the record to the database and check the result
    ...
    private void checkResult(UpdateResult updateResult, RequestVO requestVO) {
        // If the value in the database was updated, the modified count will be 1
        // The matched count can never be greater than 1 because _id is unique
