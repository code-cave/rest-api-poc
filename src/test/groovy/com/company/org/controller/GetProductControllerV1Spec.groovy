...
class GetProductControllerV1Spec extends Specification {

    GetProductControllerV1 controller = new GetProductControllerV1()
    Authentication authentication = Mock()
    GetProductValidatorV1 getProductValidatorV1 = Mock()
    GetProductServiceV1 getProductServiceV1 = Mock()
    ...
    def 'Test getProductById returns a result'() {
        ...
        when:
        ResponseEntity<String> responseEntity = controller.getProductById(id, token, applicationJson)

        then:
        1 * authentication.authenticate(_)
        1 * getProductValidatorV1.validateGetRequest(*_) >> requestVO
        1 * getProductServiceV1.doService(requestVO) >> responseVO
    ...
    def 'Test getProductById throws an error'() {
        ...
        0 * getProductServiceV1.doService(_) >> responseVO
